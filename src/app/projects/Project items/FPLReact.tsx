          ...
          {isTextBox1Visible && (
            <Fade>
              <p className="card-text text-dark">
                ...
                stats using the Fantasy Premier League API. I used{" "}
                <strong>Node</strong> and <strong>CSS</strong> and deployed on
                Render.com using a proxy server. Stats will automatically update
                throughout the season. Please note that this is hosted on a free
                server, so it may take a minute to load.
              </p>
            </Fade>
          )}
