                  ...
                  <li className="ms-3">
                    <a href="mailto:georgereade@hotmail.co.uk">
                      <svg
                        ...
                        height="32"
                        fill="#FBB201"
                        className="bi bi-envelope-at socialLinks transition ease-in-out delay-10"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <li className="ms-3">
                    <a href="https://www.linkedin.com/in/george-reade-2a1185124">
                      <svg
                        ...
                        height="32"
                        fill="#FBB201"
                        className="bi bi-linkedin socialLinks transition ease-in-out delay-10"
                        viewBox="0 0 16 16"
                      >
                  ...
                  <li className="ms-3">
                    <a href="https://github.com/georgereade/">
                      <svg
                        ...
                        height="32"
                        fill="#FBB201"
                        className="bi bi-github socialLinks transition ease-in-out delay-10"
                        viewBox="0 0 16 16"
                      >
