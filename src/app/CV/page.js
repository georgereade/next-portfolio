      ...
      <div className="container">
        ...
        <ul>
          <li>
            ...
            Mandarin. This included modules on the history and culture of China.
          </li>
          <li>
        ...
        <h5>Web Development Courses and Bootcamps</h5>
        <ul>
          <li>
        ...
        <hr />
        <h4>Experience</h4>
        <h5>Penta Group: Sector Consultant 2018 - Present</h5>
        <ul>
          <li>
          ...
          <li>
            Heavily involved in successful pitches to prospective clients in the
            role of technical, reputation and brand expert.
          </li>
          <li>
        ...
        <h4>Skills</h4>
        <p>
          Chinese (Mandarin) / Web Development / HTML / CSS / JS / Excel / SQL /
          PowerPoint / Presenting / Pre-Sales Support / Tableau / Training and
